...
def swissPairings():
    ...
    Assuming that there are an even/odd number of players registered,
    ...
    Added support for Odd number of players.
    ...
    if (numOfPlayers % 2 != 0):
        numOfPlayers -= 1  # Remove the bottom player as has a bye.
        playerHasBye = (standings[-1][0], standings[-1][1])
        print "Player has bye: " + playerHasBye

    i = 0
    listOfPairs = []  # Iterate through standings.
    while i < numOfPlayers:
        ...
        listOfPairs.append(pairing)  # Add standings to list.
        i += 2
    return listOfPairs
